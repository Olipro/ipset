...
#tests="$tests hash:net,port,net,port hash:net6,port,net6,port"
#tests="$tests hash:ip,port,ip,port hash:ip6,port,ip6,port"
tests="$tests hash:ip,port,net,port hash:ip6,port,net6,port"
