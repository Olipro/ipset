...
/* initial revision */
static struct ipset_type ipset_hash_netportnetport0 = {
	.name = "hash:net,port,net,port",
	.alias = { "netportnetporthash", NULL },
	.revision = 0,
	...
	.cmd = {
		...
		[IPSET_ADD] = {
			...
			.help = "IP[/CIDR],[PROTO:]PORT,IP[/CIDR],PORT",
		},
		[IPSET_DEL] = {
			.args = {
				IPSET_ARG_NONE,
...
void _init(void)
{
	ipset_type_add(&ipset_hash_netportnetport0);
}
